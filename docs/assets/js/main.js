...
$(document).ready(function () {
  // jQuery slider (basic fade in/out loop)
      ...
      // ]
        ...
        $.getJSON("folders.json", function (folders) {
          const $container = $("#folderContainer");
          $container.empty();
          folders.forEach(folder => {
            const firstImage = "img1.jpg"; // your standard naming
            const imagePath = `content/${folder.id}/${firstImage}`;
            
            const card = $(`
              <article class="products__card swiper-slide folder-card" data-folder="${folder.id}">
                            <img src="${imagePath}" alt="${folder.name}" class="products__img"><br/>
            ...
            card.click(function () {
              ...
              $($('.swiper-slide')[0]).addClass('swiper-slide-duplicate-active');
